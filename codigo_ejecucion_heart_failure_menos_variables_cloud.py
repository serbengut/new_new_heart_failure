...
import cloudpickle
####################################################
# me funciona en local, pero no en cloud, meto esto:
import pickle
####################################################
...
##### comento esta función y la copio abajo cambiando solamente que cargo el modelo con joblib#####
#def ejecutar_modelo(df):
#   
#    nombre_pipe_ejecucion = 'pipe_ejecucion.pickle'
#
##### cambio a pickle en vez de cloudpickle para ver si funciona en cloud, en local me funciona con cloudpickle
##    with open(nombre_pipe_ejecucion, mode='rb') as file:
##        pipe_ejecucion = cloudpickle.load(file)
#    with open(nombre_pipe_ejecucion, mode='rb') as file:
#        pipe_ejecucion = cloudpickle.load(file)
...
def ejecutar_modelo(df):
    ...
    nombre_pipe_ejecucion_joblib = 'pipe_ejecucion.joblib'

#### cambio a pickle en vez de cloudpickle para ver si funciona en cloud, en local me funciona con cloudpickle
#    with open(nombre_pipe_ejecucion, mode='rb') as file:
#        pipe_ejecucion = cloudpickle.load(file)
    with open(nombre_pipe_ejecucion_joblib, mode='rb') as file:
        pipe_ejecucion = load(open(file))
